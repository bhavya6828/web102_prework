...
const raised = GAMES_JSON.reduce((sum, game) => {
...
const unfundedString = `A total of $${raised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, there ${unfundedGames.length === 1 ? "is" : "are"} ${unfundedGames.length} unfunded ${unfundedGames.length === 1 ? "game" : "games"} remaining.`;
